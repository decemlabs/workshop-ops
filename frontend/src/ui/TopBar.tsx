...
export function TopBar() {
  ...
  return (
    <div style={s('display:grid;grid-template-columns:210px minmax(0,1fr) auto 96px;height:44px;background:var(--ink);color:var(--paper)')}>
      <div style={s("display:flex;align-items:center;padding:0 16px;border-right:1px solid rgba(var(--paper-rgb),.18);font:700 14px/1 'IBM Plex Sans Condensed',sans-serif;letter-spacing:.07em;white-space:nowrap")}>MES · ПРОИЗВОДСТВО</div>
